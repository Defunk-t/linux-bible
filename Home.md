...
1. [Boot into an installation environment](#1-boot-into-an-installation-environment)
2. [Load your keyboard layout](#2-load-your-keyboard-layout)
3. [Connect to the internet](#3-connect-to-the-internet)
4. [Refresh the package database](#4-refresh-the-package-database)
5. [Adjust time settings](#5-adjust-time-settings)
6. [Set up the file system](#6-set-up-the-file-system)
   - [Zero-fill](#optional-zero-fill)
   - [Partitioning](#partitioning)
   - [Encryption](#set-up-encryption)
   - [LVM](#set-up-lvm)
   - [Formatting](#create-file-systems)
7. [Mount volumes](#7-mount-volumes)
8. [Install packages](#8-install-packages)
9. [Generate & tweak fstab](#9-generate--tweak-fstab)
10. [Configure Arch Linux](#10-configure-arch-linux)
...
starts to get into the BIOS or UEFI menu - just in case you need to change the boot order in order to get your
machine to boot from the USB drive.
